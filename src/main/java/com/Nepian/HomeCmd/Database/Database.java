package com.Nepian.HomeCmd.Database;
...
public abstract class Database {
    ...
    public String table = "table_name"; // The name of the table we created back in SQLite class.
    public int tokens = 0;
    ...
    protected void initialize(){
        ...
        try{
            PreparedStatement ps =
            		connection.prepareStatement("SELECT * FROM " + table + " WHERE player = ?");
